...
while True:
    ...
    if ord(ch)==27:  # escape
        ...
        writeCommandToCurrentPanel("Step UP", "o:5,50,100" ,"o:80,50,200")
    elif ch == '9':
        writeCommandToCurrentPanel("Step UP_RIGHT", "o:1,50,50", "o:16,50,200")
    elif ch == '6':
        writeCommandToCurrentPanel("Step RIGHT", "o:9,50,50", "o:144,50,200")
    elif ch == '3':
        writeCommandToCurrentPanel("Step DOWN_RIGHT", "o:8,50,100" ,"o:128,50,200")
    elif ch == '2':
        writeCommandToCurrentPanel("Step DOWN", "o:10,50,100" ,"o:160,50,200")
    elif ch == '1':
        writeCommandToCurrentPanel("Step DOWN_LEFT", "o:2,50,100" ,"o:32,50,200")
    elif ch == '4':
        writeCommandToCurrentPanel("Step LEFT", "o:6,50,100" ,"o:96,50,200")
    elif ch == '7':
        writeCommandToCurrentPanel("Step UP_LEFT", "o:4,50,100" ,"o:64,50,200")
